...
ExpenseModel _expenseModelDeserialize(
  ...
  final object = ExpenseModel(
    ...
    deviceId: reader.readString(offsets[4]),
    id: id,
...
extension ExpenseModelQueryWhereSort
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhere> anySyncedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQueryWhere
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> syncedAtEqualTo(
      DateTime syncedAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> syncedAtLessThan(
    DateTime syncedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> syncedAtBetween(
...
extension ExpenseModelQueryFilter
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> paidByEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> paidByBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> paidByMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension ExpenseModelQuerySortBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByDeviceId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceId', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByDeviceIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByPaidBy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidBy', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByPaidByDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQuerySortThenBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByDeviceId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceId', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByDeviceIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceId', Sort.desc);
    });
  }
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByPaidBy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidBy', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByPaidByDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidBy', Sort.desc);
    });
  }
...
extension ExpenseModelQueryWhereDistinct
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByDeviceId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByPaidBy(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQueryProperty
  ...
  QueryBuilder<ExpenseModel, String, QQueryOperations> deviceIdProperty() {
    return QueryBuilder.apply(this, (query) {
